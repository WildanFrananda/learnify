    ...
    <div class="container py-5 px-lg-5">
        <div class="row g-5">
            <div class="col-md-6 col-lg-3">
                ...
                <p><i class="fa fa-map-marker-alt me-3"></i>Kemayoran, Jakarta Raya, Indonesia</p>
                <p><i class="fa fa-phone-alt me-3"></i>+62 851 5858 3357</p>
                <p><i class="fa fa-envelope me-3"></i>wild21345ti@student.nurulfikri.ac.id</p>
            ...
            <div class="col-md-6 col-lg-3">
                ...
                <p>Keep Up With The Latest Learn new skills and insights from our experts and instructors. Join our newsletter and get access to exclusive content and offers.</p>
        ...
        <div class="copyright">
            <div class="row">
                <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                    &copy; <a class="border-bottom" href="#">learnify.com</a>, All Right Reserved. 
                    
                    <!--/*** This template is free as long as you keep the footer author’s credit link/attribution link/backlink. If you'd like to use the template without the footer author’s credit link/attribution link/backlink, you can purchase the Credit Removal License from "https://htmlcodex.com/credit-removal". Thank you for your support. ***/-->
                    Developed By <a class="border-bottom" href="https://github.com/WildanFrananda">Wildan Frananda</a><br><br>
                </div>
